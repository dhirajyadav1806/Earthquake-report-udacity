...
public class EarthquakeAdapter extends ArrayAdapter<Earthquake> {
    ...
    private int getMagnitudeColor(double magnitude) {
        ...
        int magnitudeFloor = (int) Math.floor(magnitude);//finding the closest integer less than the decimal value. The floor of the value 1.2 would be the integer 1
        switch (magnitudeFloor) {
            ...
            default:
                ...
                //convert the color resource ID(magnitudeColorResourceId) into a color integer value
